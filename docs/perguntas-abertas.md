...
| Id | Pergunta | Bloqueado hoje | Quando você responder |
|---|---|---|---|
| **[P-23]** | Autoriza revisar o **PRD** para incorporar as D-027 a D-034? Três pontos medidos divergem: a tabela de pesos do ranking (60/80 · 25/10 · 15/10), a disputa de "dez candidatos por vaga" no super destaque, e as "nove regras" da linha :490 — que a D-027 fez voltar a ser nove, por outro caminho, o que muda a pergunta da **[P-18]**. | **A hierarquia aponta para o lado errado.** O PRD é o documento superior e hoje contradiz a Spec 1.1 e o código nesses três pontos; vale a regra de que a decisão registrada prevalece, mas quem ler só o PRD lê o critério antigo. | O PRD passa a dizer o que o sistema faz, e a **[P-18]** é respondida dentro dessa revisão em vez de antes dela. |
