...
| **[P-25]** — peso das visualizações | Com 23,9 % do estoque tendo visualizações (13.175 de 55.162, coleta completa de 06/09), o peso continua **zero**? A D-034 o adotou citando "zero em 300 de 300" — medição de 300 anúncios que a coleta completa derrubou. | **Nada trava**: o valor adotado segue vigente e a rodada usa zero. Mas um sinal presente em quase um quarto do estoque não pesa nada na nota que ordena a vitrine. | `src/config/adotados.py` já tem a fiação — é trocar o número. Os três pesos somam 100, então subir este baixa os outros dois. |
