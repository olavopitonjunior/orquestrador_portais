...
**Incorporado**: o detalhe completo — série do pipeline, cortes por regra, distribuição de corretores por distrito e a sensibilidade ao mínimo — está em [`mapa-de-dados.md`](mapa-de-dados.md), seção "O funil pelo pipeline". O PRD 6.0 declara a deriva como ressalva datada (D-035). **O que continua sendo seu**: decidir se a disputa de "dez candidatos por vaga" no super destaque, que fundou o objetivo de ranking daquele nível e hoje é de 7,5, ainda sustenta o desenho — e isso não é medição, é critério.

**Pendência que continua aberta, agora rastreada aqui:** o corpo do **PRD 6.0**, a **Spec 1.1** e o **`CLAUDE.md`** ainda publicam 10.290 elegíveis, 4.852 candidatos ao super, folga de 48% e 10,2 por vaga. Esta fatia deliberadamente **não** os tocou: revisá-los mexe na premissa que fundou o objetivo de ranking do super destaque, e essa é a decisão do parágrafo acima. É fatia própria, e ela depende da sua resposta.
