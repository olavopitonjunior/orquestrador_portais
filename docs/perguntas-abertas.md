...
**Fechadas em 2026-09-04 (D-027 a D-034)** — ficam aqui para a referência não apontar para o vazio: nº 3 (descontos em pontos de 100 e perdão por semana, D-030/D-034), nº 5 e nº 7 (idade máxima e cobertura mínima da raspagem, D-034), **[P-15]** (composição do sinal de portal, fechada por medição: visualizações 0 em 300 de 300, D-028), **[P-16]** (desconto do perfil frágil — deixou de existir, D-027). Os nº 12 e nº 13 **deixaram de existir** sem receber valor (D-031): com o perfil como filtro e o portal como nota, a pergunta desapareceu.
