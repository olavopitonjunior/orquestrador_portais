...
# --- prioridade das dimensões e peso decrescente (D-017) ----------------------


def test_prioridade_e_a_ordem_adotada_do_dono():
    # D-017 (palavras do dono): preço > localização > metragem > dormitórios > vagas.
    assert PRIORIDADE_DIMENSOES == (
