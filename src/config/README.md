...
Onze parâmetros estão pendentes (consolidação D-004) e devem permanecer nulos até serem definidos — a lista está no `CLAUDE.md`. Nenhum pode ser preenchido com valor inventado.
