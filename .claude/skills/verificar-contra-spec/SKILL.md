...
4. **Confira que nenhum parâmetro pendente ganhou valor.** Os onze da tabela do CLAUDE.md (consolidação D-004) permanecem nulos. Valor inventado é erro grave, mesmo "provisório".
