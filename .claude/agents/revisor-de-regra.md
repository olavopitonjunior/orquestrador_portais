...
Catorze parâmetros estão nulos, de quinze (lista consolidada pela D-004 no CLAUDE.md). Se encontrar qualquer valor concreto preenchendo um deles no código, é erro grave: nenhum pode ser inventado.
