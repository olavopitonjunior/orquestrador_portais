...
- **Caminho de modelo na raspagem: NÃO existe.** A Ferramentas §2 previa "determinístico por seletores primeiro, modelo interpretando a página quando falha"; a **D-010** removeu isso do Coletor Externo v0, e o dono confirmou em 2026-09-06 (**D-037**) — no desenho atual não há página a interpretar. Se um dia for reintroduzido, a D-010 já fixou a obrigação: nenhum payload do painel vai a modelo sem remoção de identidades antes do envio (invariante 3).
